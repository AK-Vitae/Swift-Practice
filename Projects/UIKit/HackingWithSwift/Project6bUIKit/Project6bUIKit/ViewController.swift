...
//  Project6bUIKit
//
//  Created by Ramadugu, Akshith on 4/3/22.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let label1 = UILabel()
        label1.translatesAutoresizingMaskIntoConstraints = false // Need to set autolayout contraints manually
...
//
//            // H: parts means that we're defining a horizontal layout
...
//
//        view.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|[label1(labelHeight@999)]-[label2(label1)]-[label3(label1)]-[label4(label1)]-[label5(label1)]->=10-|", options: [], metrics: metrics, views: viewsDictionary)) // "-" means 10pt space
//        // VFL doesn't have a pipe at the end, so we're not forcing the last label to stretch all the way to the edge of our view
